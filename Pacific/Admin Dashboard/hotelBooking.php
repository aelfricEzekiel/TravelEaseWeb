        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <!-- Page Heading -->
                    <h1 class="h3 mb-1 text-gray-800">Hotel Booking Table</h1>
                    <!-- Content Row -->
                    <div class="row">
                                    ...
                                    while ($display_data = mysqli_fetch_array($table_data)) {
                                        ?>
                                            <tr>
                                                ...
                                                <td><?php echo $display_data['hotel'] ?></td>
                                                <td><?php echo $display_data['start_date'] ?></td>
                                                <td><?php echo $display_data['end_date'] ?></td>
                                                <td><?php echo $display_data['price'] ?></td>
                                                <td><?php echo $display_data['people'] ?></td>
                                                <td><a href="../CRUD/deleteHotelBook.php?del_id=<?php echo $display_data['id'] ?>" data-toggle="modal" data-target="#deleteRow"><i class="fa-solid fa-trash"></i></a></td>
