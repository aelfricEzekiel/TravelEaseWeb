			...
			<div class="modal-content">
				<form action="process.php" method="POST">
					...
					<div class="modal-body">
						...
						<div class="input-group">
							<span class="input-group-text"><i class="fa-solid fa-key"></i></span>
							<input type="password" class="form-control" placeholder="Enter confirm password" required name="confirm_pass">
						</div>	
					</div>
					<div class="modal-footer">
						<button type="reset" class="btn btn-secondary">Reset</button>
						<button type="submit" class="btn btn-success" name="createTouristAccount" value="CREATE">Create Account</button>
					</div>
				</form>
			</div>
		</div>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<form action="process.php" method="post">
					...
					<div class="modal-footer">
						<button type="reset" class="btn btn-secondary">Reset</button>
						<button type="submit" class="btn btn-success" name="loginTourist" value="LOGIN">Login as Tourist</button>
					</div>
				</form>
			</div>
		</div>
			...
			<div class="modal-content">
				<form action="process.php" method="post">
					...
					<div class="modal-footer">
						...
						<button type="submit" class="btn btn-success" name="admin_login" value="LOGIN">Login</button>
					</div>
				</form>
			</div>
		</div>
      ...
      <div class="row mb-5">
        <div class="col-md pt-5">
          <div class="ftco-footer-widget pt-md-5 mb-4">
            ...
            <p>Far far away, behind the world mountains, there live the peace.</p>
        ...
        <div class="col-md pt-5 border-left">
          <div class="ftco-footer-widget pt-md-5 mb-4">
            ...
            <div class="block-23 mb-3">
              <ul>
                <li><span class="icon fa fa-map-marker"></span><span class="text">SM City Iloilo, Travel Ease Agency 2nd
                    Floor, Mandurriao Iloilo City, Philippines</span></li>
                <li><a href="#"><span class="icon fa fa-phone"></span><span class="text">+63 989 321 5645</span></a>
                </li>
