				...
				<form action="process.php" method="POST">
					...
					<div class="modal-body">
						...
						<div class="input-group">
							...
							<input type="text" class="form-control" placeholder="Enter First Name" required name="firstName">
						</div>
						<label>Last Name</label>
						<div class="input-group">
							<span class="input-group-text"><i class="fa-solid fa-user"></i></span>
							<input type="text" class="form-control" placeholder="Enter Last Name" required name="lastName">
						</div>
						<label>Email</label>
						<div class="input-group">
						...
						<div class="input-group">
							<span class="input-group-text"><i class="fa-solid fa-key"></i></span>
							<input type="password" class="form-control" placeholder="Enter confirm password" name="confirm_pass" required>
						</div>	
					</div>
